$(document).ready(function(){
  ...
  $("#pwd").focusout(function(){IsPwd("#pwd");});
  $(".logOn").click(function(){IsPwd("#pwd");});
  $("#newPwd").focusout(function(){IsPwd("#newPwd");});

  $("#newName").focusout(function(){IsName("#newName");});

  $(".newLogOn").click(function(){validation("#newUser","#newPhone","#newPwd","#newName");});
});
